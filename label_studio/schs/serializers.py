...
class SchIdSerializer(DynamicFieldsMixin, serializers.ModelSerializer):
    class Meta:
        model = Sch
        fields = ['id', 'title']
...
class SchMemberSerializer(DynamicFieldsMixin, serializers.ModelSerializer):
    class Meta:
        model = SchMember
        fields = ['id', 'sch', 'user']
...
class SchMemberUserSerializer(DynamicFieldsMixin, serializers.ModelSerializer):
...
class SchInviteSerializer(serializers.Serializer):
